...
public class Customer {
    ...
    private static String customers [][] = new String[6][3];
    private static Scanner input  = new Scanner(System.in);
    private static ArrayList <String> waitingQueue = new ArrayList<>();
    ...
    public static void moveCustomerNamesForward(int customerPos){
        for (int rows = 0; rows < customers.length-1;rows++){
            if(customers[rows][customerPos-1] != null){
                if(customers[rows+1][customerPos-1] != null){
                    ...
                    if (waitingQueue.isEmpty()){
                        ...
                        customers[rows][customerPos-1] = waitingQueue.get(0);
    ...
    private static void moveCustomerNamesForward(int queueNo,int customerPos){
        for (int rows = customerPos-1; rows <customers.length-1; rows++){
    ...
    public static void addCustomerToWaitingQueue(){
        ...
        waitingQueue.add(getFullName(firstName,lastName));
        System.out.println(waitingQueue.toString());
    }

    // reference - how to return an arraylist - https://stackoverflow.com/questions/9034881/how-to-return-an-arraylist
