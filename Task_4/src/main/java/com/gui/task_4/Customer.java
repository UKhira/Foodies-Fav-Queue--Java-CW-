...
public class Customer {
    ...
    private static String [] waitingQueue = new String[10];
    ...
    /*
    * to return names to GUI
    * @param - row, col
    * @return the name to specific index
     */
    public static String getCustomerNameByIndex(int row, int col){
        if (customers[row][col] != null){
    ...
    public static void addCustomerToWaitingQueue(){
        ...
        try {
            for (int index = 0; index < waitingQueue.length; index++) {
                if (waitingQueue[index] == null) {
                    waitingQueue[index] = (getFullName(firstName, lastName));
                    break;
                }
            }
        }
    ...
    public static String getWaitingQueue(int index){
        if(waitingQueue[index] != null){
            return waitingQueue[index];
        }
        else {
            return "<No Customer>";
        }
